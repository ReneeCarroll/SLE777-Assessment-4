...
First, install and load two required packages, Seqinr and R.utils. 
Seqinr is a package designed to process and analyse sequence data.
R.utils is a general utilities package, which will be used here to unzip files.
...
The coding DNA sequence files (cds files) can be downloaded from Ensembl's database, using the respective URL. 
